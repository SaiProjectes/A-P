 ...
 */
@Entity
@Table(name="dbo.con_articulos")
public class ConArticulos implements Serializable {
    @Id
    @Column(name="codigo")
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Objects.hashCode(this.dataAccio);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ConArticulos other = (ConArticulos) obj;
