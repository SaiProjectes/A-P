 ...
 */
@Entity 
@Table(name="dbo.con_marcas")
public class ConMarcas implements Serializable {
    @Id
    @Column(name="codigo")
    ...
    public int hashCode() {
        ...
        hash = 67 * hash + Objects.hashCode(this.dataAccio);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ConMarcas other = (ConMarcas) obj;
