...
public class GestorTraspas implements IGestioTraspas{
    ...
    @Override
    public void actualitzarPedidos(String vendedor, String idLista, String idDept, String idEmpresa, String idEmpleat,  String idRepr) throws GestioTraspasException {
        TraspasManagerOrders tmo = new TraspasManagerOrders(emSQLServer, emMySQL);
        //aqui faltaria els nous parametres
